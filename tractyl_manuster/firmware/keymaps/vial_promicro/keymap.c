...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =                                //
    {[0] = LAYOUT_base(                                                                     //
         ...
         KC_ENT, KC_LALT, KC_ENT, TT(2), TT(3), TT(3), TT(2)                                //
         ),
     [1] = LAYOUT_base(                                                                                              //
     ...
     [2] = LAYOUT_base(                                                                                            //
         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_INS, KC_SCRL, KC_PAUS, KC_NUM, KC_TRNS, //
         KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_VOLU, KC_GRV, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_TRNS,         //
         KC_TRNS, KC_F5, KC_F6, KC_F7, KC_F8, KC_VOLD, KC_F20, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_TRNS,          //
         KC_TRNS, KC_F9, KC_F10, KC_F11, KC_F12, KC_MUTE, KC_TILD, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TRNS,    //
