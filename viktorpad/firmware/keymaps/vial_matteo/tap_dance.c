...
// Source: [ScottoT9](https://github.com/joe-scotto/scottokeebs/blob/main/ScottoT9/QMK/keymaps/scotto/tapdance.c)
...
static void t9_handler(td_state_t state, bool press, uint16_t kc1, uint16_t kc2, uint16_t kc3, uint16_t kc4, uint16_t kc_num) {
    uint16_t key = KC_NO;
    switch (state) {
        case TD_SINGLE_TAP:
            key = kc1;
