...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [2] = {ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS),                           // WASD
           ENCODER_CCW_CW(KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK),                                     //
           ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},                                                            //
    [3] = {ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS),                           // Mouse
           ENCODER_CCW_CW(ZOOM_REL, ZOOM_RER),                                                           //
           ENCODER_CCW_CW(ALT_GUI_REL, ALT_GUI_RER)},                                                    //
    [4] = {ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS),                           // T9 Keypad
           ENCODER_CCW_CW(KC_TRNS, KC_TRNS),                                                             //
           ENCODER_CCW_CW(KC_TRNS, KC_TRNS)},                                                            //
    [5] = {ENCODER_CCW_CW(DT_DOWN, DT_UP), ENCODER_CCW_CW(KC_NO, KC_NO),                                 // Settings
